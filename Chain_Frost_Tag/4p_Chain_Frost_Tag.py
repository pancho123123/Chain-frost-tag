...
class Frost1(pygame.sprite.Sprite):
	...
	def update(self):
		if self.hit:
			target_list = [player1, player2, player3, player4, penguin1, penguin2, penguin3, 
...
while running:
	...
	# Checar colisiones - player4 - frost
	hits = pygame.sprite.spritecollide(player4, frost_list, False)
	for hit in hits:
		if frost1.target == player4:
			chain_frost_sound2.play()
			player4.counter = False
			player4.hp -= 90
			penguin1.counter = True
			penguin2.counter = True
			penguin3.counter = True
